...
const { AddBid, SingleBid, DeleteBid, SelfBid, ProductBid, AllBid,  ProductDelivery, ProductDeliveryCompleted, GetAllOrder, UserBid } = require('../../controllers/bid.controller');
